/**
 * Created by Chantouch on 7/7/2017.
 */
    ...
    hooks.defineLocale('km', {
        ...
        preparse: function (string) {
            return string.replace(/[១២៣៤៥៦៧៨៩០]/g, function (match) {
                return numberMap$Km[match];
            });
        },
        postformat: function (string) {
            return string.replace(/\d/g, function (match) {
                return symbolMap$Km[match];
            });
        },
        meridiemParse: /យប់|ព្រឹក|រសៀល|ល្ងាច/,
        meridiemHour: function (hour, meridiem) {
            if (hour === 12) {
                hour = 0;
            }
            if (meridiem === 'យប់') {
                return hour < 4 ? hour : hour + 12;
            } else if (meridiem === 'ព្រឹក') {
                return hour;
            } else if (meridiem === 'រសៀល') {
                return hour >= 10 ? hour : hour + 12;
            } else if (meridiem === 'ល្ងាច') {
                return hour + 12;
            }
        },
        meridiem: function (hour, minute, isLower) {
        ...
        dayOfMonthOrdinalParse: /\d{1,2}(ទី)/,
        ordinal: function (number) {
            return number + 'ទី';
        },
        week: {
